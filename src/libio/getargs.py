...
def getargs():
    ...
    parser.add_argument('--inputdir',  help='input dir',required=False,type=str,default='')
    parser.add_argument('--outputdir', help='output dir',required=False,type=str,default='')
